...
{
    const cv::Scalar kLowerBlue(100, 150, 50);
    const cv::Scalar kUpperBlue(140, 255, 255);

    const cv::Scalar kLowerRed1(0, 120, 70);
    const cv::Scalar kUpperRed1(10, 255, 255);
    const cv::Scalar kLowerRed2(170, 120, 70);
    const cv::Scalar kUpperRed2(180, 255, 255);

    const cv::Scalar kLowerGreen(25, 22, 22);
    ...
    constexpr int kPlayerMinArea = 500;
    constexpr int kPlayerKernelSize = 5;
    ...
    constexpr const char *kInputImagePath = "input/ball_unobscured.jpg";
    constexpr const char *kOutputImagePath = "output/output.jpg";
    constexpr const char *kFieldMaskPath = "output/field_mask.jpg";
    constexpr const char *kBallMaskPath = "output/ball_mask.jpg";
} // namespace detector_config
